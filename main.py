...
fh = logging.FileHandler('log/main.txt')
    ...
    try:
        ...
        for directory in directories:
            if not os.path.exists(directory):
                ...
                logger.info("Succeed in create the directory {}".format(directory))
        ...
        logger.info("Succeed in set the database {}".format("./requests_databases/" + db_name))
        ...
        logger.info("Succeed in get parameters and parse then")
        ...
        logger.info("Register request in the request_manager")
        ...
        logger.info("Some processes fail in running")
